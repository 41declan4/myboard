...
<html lang="en">
    ...
    <body class="text-center">
        ...
        <input type="text" id="username" class="form-control" placeholder="Username" value="${principal.user.username}" disabled required="required" autofocus>
        <label for="password" class="sr-only">Password</label>
        <input type="password" id="password" class="form-control" placeholder="Password" required="required">
        <label for="email" class="sr-only">Email</label>
        <input type="email" id="email" class="form-control" placeholder="Email" value="${principal.user.email}" required="required">
